...
ftp1 = FantasyTeamPlayer.create!(active: true, first_team: true, football_player: fp1, fantasy_team: ft1)
ftp2 = FantasyTeamPlayer.create!(active: true, first_team: true, football_player: fp2, fantasy_team: ft1)
ftp3 = FantasyTeamPlayer.create!(active: true, first_team: true, football_player: fp3, fantasy_team: ft2)
ftp4 = FantasyTeamPlayer.create!(active: true, first_team: true, football_player: fp4, fantasy_team: ft2)
ftp5 = FantasyTeamPlayer.create!(active: true, first_team: true, football_player: fp5, fantasy_team: ft3)
ftp6 = FantasyTeamPlayer.create!(active: true, first_team: true, football_player: fp6, fantasy_team: ft3)
ftp7 = FantasyTeamPlayer.create!(active: true, first_team: true, football_player: fp7, fantasy_team: ft4)
ftp8 = FantasyTeamPlayer.create!(active: true, first_team: true, football_player: fp8, fantasy_team: ft4)
ftp9 = FantasyTeamPlayer.create!(active: true, first_team: true, football_player: fp9, fantasy_team: ft1)
ftp10 = FantasyTeamPlayer.create!(active: true, first_team: true, football_player: fp10, fantasy_team: ft1)
ftp11 = FantasyTeamPlayer.create!(active: true, first_team: true, football_player: fp11, fantasy_team: ft2)
ftp12 = FantasyTeamPlayer.create!(active: true, first_team: true, football_player: fp12, fantasy_team: ft2)
ftp13 = FantasyTeamPlayer.create!(active: true, first_team: true, football_player: fp13, fantasy_team: ft3)
ftp14 = FantasyTeamPlayer.create!(active: true, first_team: true, football_player: fp14, fantasy_team: ft3)
ftp15 = FantasyTeamPlayer.create!(active: true, first_team: true, football_player: fp15, fantasy_team: ft4)
ftp16 = FantasyTeamPlayer.create!(active: true, first_team: true, football_player: fp16, fantasy_team: ft4)
ftp17 = FantasyTeamPlayer.create!(active: true, first_team: true, football_player: fp17, fantasy_team: ft1)
ftp18 = FantasyTeamPlayer.create!(active: true, first_team: true, football_player: fp18, fantasy_team: ft2)
ftp19 = FantasyTeamPlayer.create!(active: true, first_team: true, football_player: fp19, fantasy_team: ft3)
ftp20 = FantasyTeamPlayer.create!(active: true, first_team: true, football_player: fp20, fantasy_team: ft4)
